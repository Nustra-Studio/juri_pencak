            ...
            <div class="blueScore table-responsive">
                ...
                <div class="d-flex justify-content-between">
                    <div class="btn-wrap d-flex flex-column">
                        ...
                        <button name="juri:{{$id_juri}} id:1 status:tendangan p:3 keterangan:plus" class="btnSkill1 d-flex align-items-center justify-content-center btn btn-primary fs-2 px-5 py-4 me-1 shadow border-black">
